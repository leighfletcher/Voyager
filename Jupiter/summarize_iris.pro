...
zread_irisdata,sfilename,data,ntotal,planet
 ...
 set_plot,'ps'
 device,filename='uranus_irisdata.eps',/encapsulated,xsize=9,ysize=18
 !p.font=0
 ...
 k=where(data.picture_body eq 0 and $
 data.count ge 2678300 and data.count le 2690900 and $
