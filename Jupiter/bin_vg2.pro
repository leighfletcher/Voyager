...
files=file_search('VGIRIS_0001_peer_review/DATA/JUPITER_VG2/*_LSB.DAT')

;READ IN VOYAGER 1 NESR SPECTRUM
nwaven=file_lines('/home/l/lnf2/projects/IRIS/IRISdata/PDS/jupiter/VGIRIS_0001_peer_review/CALIB/JUPITER_VG2_NESR.TAB')
tmp=fltarr(2,nwaven)
openr,1,'/home/l/lnf2/projects/IRIS/IRISdata/PDS/jupiter/VGIRIS_0001_peer_review/CALIB/JUPITER_VG2_NESR.TAB'
readf,1,tmp
close,1
nesr = tmp(1,*)
...
save,filename='vg2.sav',data,jd,mderiv

endif

stop

if iread eq 0 then restore,'vg2.sav'
jd=jd+2400000.5


set_plot,'ps'
device,filename='jupiter_vg2irislat.eps',encapsulated=0
!p.font=0
pcircle
...
jdmin=date_conv('1979-07-06 12:00:00','J')
jdmax=date_conv('1979-07-07 12:00:00','J')
...
set_plot,'ps'
device,filename='jupiter_v2spx.eps',encapsulated=0
!p.font=0
pcircle
loadct,0
...
for ilat=0,nlats-1 do begin
    ...
    k=where(data.q5_latitude ge lat1 and data.q5_latitude le lat2 and jd ge jdmin and jd le jdmax)
    ...
    k=where(data.q5_latitude ge lat1 and $
	  ...
	  data.emiss_angle le emm2 and $
        data.thermal_radiance_spectrum[wkeep1] ge 5.e-7 and jd ge jdmin and jd le jdmax)
