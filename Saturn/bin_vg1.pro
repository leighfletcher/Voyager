files=file_search('VGIRIS_0002_peer_review/DATA/SATURN_VG1/*_LSB.DAT')
;files=['VGIRIS_0002_peer_review/DATA/SATURN_VG2/C4392XXX_LSB.DAT',$
;'VGIRIS_0002_peer_review/DATA/SATURN_VG2/C4393XXX_LSB.DAT',$
;'VGIRIS_0002_peer_review/DATA/SATURN_VG2/C4394XXX_LSB.DAT',$
;'VGIRIS_0002_peer_review/DATA/SATURN_VG2/C4395XXX_LSB.DAT',$
;'VGIRIS_0002_peer_review/DATA/SATURN_VG2/C4396XXX_LSB.DAT',$
;'VGIRIS_0002_peer_review/DATA/SATURN_VG2/C4397XXX_LSB.DAT',$
;'VGIRIS_0002_peer_review/DATA/SATURN_VG2/C4398XXX_LSB.DAT',$
;'VGIRIS_0002_peer_review/DATA/SATURN_VG2/C4399XXX_LSB.DAT',$
;'VGIRIS_0002_peer_review/DATA/SATURN_VG2/C4400XXX_LSB.DAT']

;files=['VGIRIS_0002_peer_review/DATA/SATURN_VG2/C4397XXX_LSB.DAT']

;READ IN VOYAGER 1 NESR SPECTRUM
nwaven=file_lines('/home/jupiter/plan/fletcher/projects/IRIS/IRISdata/PDS/saturn/VGIRIS_0002_peer_review/CALIB/SATURN_VG1_NESR.TAB')
tmp=fltarr(2,nwaven)
openr,1,'/home/jupiter/plan/fletcher/projects/IRIS/IRISdata/PDS/saturn/VGIRIS_0002_peer_review/CALIB/SATURN_VG1_NESR.TAB'
readf,1,tmp
close,1
nesr = tmp(1,*)

;['VGIRIS_0002_peer_review/DATA/SATURN_VG1/C3443XXX_LSB.DAT',$
;   'VGIRIS_0002_peer_review/DATA/SATURN_VG1/C3479XXX_LSB.DAT',$
;   'VGIRIS_0002_peer_review/DATA/SATURN_VG1/C3489XXX_LSB.DAT',$
;   'VGIRIS_0002_peer_review/DATA/SATURN_VG1/C3490XXX_LSB.DAT',$
;   'VGIRIS_0002_peer_review/DATA/SATURN_VG1/C3491XXX_LSB.DAT',$
;   'VGIRIS_0002_peer_review/DATA/SATURN_VG1/C3492XXX_LSB.DAT',$
;   'VGIRIS_0002_peer_review/DATA/SATURN_VG1/C3493XXX_LSB.DAT',$
;   'VGIRIS_0002_peer_review/DATA/SATURN_VG1/C3494XXX_LSB.DAT',$
;   'VGIRIS_0002_peer_review/DATA/SATURN_VG1/C3495XXX_LSB.DAT',$
;   'VGIRIS_0002_peer_review/DATA/SATURN_VG1/C3496XXX_LSB.DAT',$
;   'VGIRIS_0002_peer_review/DATA/SATURN_VG1/C3497XXX_LSB.DAT',$
;   'VGIRIS_0002_peer_review/DATA/SATURN_VG1/C3498XXX_LSB.DAT',$
;   'VGIRIS_0002_peer_review/DATA/SATURN_VG1/C3499XXX_LSB.DAT']
    ...
    ;for i=0,nrecords-1 do begin
        ...
        if ( $
           ; total(mRecord.thermal_radiance_spectrum) gt 0. and $
            ...
            mRecord.dist_sc_pb lt 2.6e6 and $
            mRecord.picture_body eq 0 and $
            ;    data.pb_semi_diam le 1.6 and $
		mRecord.central_body eq 6 and $
		mRecord.emiss_angle le 80 and $
...
set_plot,'ps'
device,filename='saturn_vg1irislat.eps',/encapsulated
!p.font=0
pcircle
ca_v1=date_conv('1980-11-13 00:00:00','J')
ca_v2=date_conv('1981-08-26 00:00:00','J')

date_label=LABEL_DATE(DATE_FORMAT=['%Y/%N/%D'])


plot,[ca_v1-2.,ca_v1+2.],[-90,90],/nodata,xs=1,ys=1,$
...
set_plot,'ps'
device,filename='saturn_v1spx.eps',encapsulated=0
!p.font=0
pcircle
loadct,0
...
for ilat=0,nlats-1 do begin
    ...
    k=where(data.q5_latitude ge lat1 and data.q5_latitude le lat2)
    ...
    k=where(data.q5_latitude ge lat1 and $
	  ...
	  data.emiss_angle le emm2 and $
        data.thermal_radiance_spectrum[wkeep1] ge 5.e-7)
...
;VGIRIS_0002_peer_review/DATA/SATURN_VG2/C4393XXX.TAB
;VGIRIS_0002_peer_review/DATA/SATURN_VG2/C4394XXX.TAB
;VGIRIS_0002_peer_review/DATA/SATURN_VG2/C4395XXX.TAB
;VGIRIS_0002_peer_review/DATA/SATURN_VG2/C4396XXX.TAB
;VGIRIS_0002_peer_review/DATA/SATURN_VG2/C4397XXX.TAB
;VGIRIS_0002_peer_review/DATA/SATURN_VG2/C4398XXX.TAB
;VGIRIS_0002_peer_review/DATA/SATURN_VG2/C4399XXX.TAB
;VGIRIS_0002_peer_review/DATA/SATURN_VG2/C4400XXX.TAB
